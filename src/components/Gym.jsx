...
const workoutTemplates = {
  ...
  protocol90: {
    ...
    split: [
      { key: 'upper1', title: 'Upper 1 (Heavy)', focus: 'Upper Chest Priority' },
      { key: 'lower1', title: 'Lower 1 (Power)', focus: 'Heavy Compound Strength' },
      { key: 'aesthetics', title: 'Aesthetics & Engine', focus: 'Shoulders, Arms & Abs' },
      { key: 'upper2', title: 'Upper 2 (Volume)', focus: 'Hypertrophy & Pump' },
      { key: 'lower2', title: 'Lower 2 (Definition)', focus: 'Leg Volume & Core' },
      { key: 'rest1', title: 'Active Rest', focus: 'Cardio only - recovery day' },
      { key: 'rest2', title: 'Active Rest', focus: 'Cardio only - recovery day' },
    ],
    exercises: {
      upper1: [
        { name: 'Incline Dumbbell Press', target: 'Upper Chest Shelf', reps: '3×10–12', note: '🔥 FOCUS: Upper chest shelf' },
        { name: 'Flat Dumbbell Press', target: 'Heavy', reps: '3×8–10', note: 'Full range of motion' },
        { name: 'Lat Pulldowns', target: 'Wide Grip', reps: '3×10–12' },
        { name: 'Seated Cable Rows', target: 'Thickness', reps: '3×12' },
        { name: 'Seated Dumbbell Shoulder Press', target: 'Heavy', reps: '3×8–10' },
        { name: 'Tricep Pushdowns', target: 'Squeeze', reps: '3×15' },
        { name: 'Cardio Finisher', target: '12% Incline', reps: '20 Mins', note: '🔥 NO PHONE until 3 songs done' },
      ],
      lower1: [
        { name: 'Squats (or Hack Squat)', target: 'Heavy', reps: '3×8–10' },
        { name: 'Leg Press', target: 'Heavy', reps: '3×10–12' },
        { name: 'Seated Hamstring Curls', target: 'Controlled', reps: '3×12' },
        { name: 'Calf Raises', target: 'Full range', reps: '4×15' },
        { name: 'Plank', target: 'Core', reps: '3×60s' },
        { name: 'Cardio Finisher', target: '12% Incline', reps: '20 Mins', note: '🔥 NO PHONE until 3 songs done' },
      ],
      aesthetics: [
        { name: 'Dumbbell Lateral Raises', target: 'Light, No Swing', reps: '4×15–20', note: '🔥 STRICT FORM only' },
        { name: 'Hammer Curls', target: 'Control weight', reps: '3×10–12' },
        { name: 'Face Pulls', target: 'Rear Delts', reps: '3×15' },
        { name: 'Skull Crushers', target: 'Triceps', reps: '3×12' },
        { name: 'Hanging Leg Raises', target: 'Abs', reps: '3×Failure' },
        { name: 'The "Truth" Burn', target: '15% Incline @ 4.8', reps: '20 Mins', note: '🔥 MAX INCLINE. Don\'t stop.' },
      ],
      upper2: [
        { name: 'Incline Machine Press', target: 'Volume', reps: '3×12–15' },
        { name: 'Pec Fly Machine', target: 'Squeeze', reps: '3×15', note: 'Focus on the squeeze' },
        { name: 'Machine Preacher Curls', target: 'Biceps', reps: '3×12' },
        { name: 'Rear Delt Machine', target: 'Rear Delts', reps: '3×15' },
        { name: 'Machine Rows', target: 'Lats', reps: '3×12' },
        { name: 'Pushups', target: 'Burnout', reps: '2×Failure' },
        { name: 'Cardio Finisher', target: '12% Incline', reps: '20 Mins', note: '🔥 NO PHONE until 3 songs done' },
      ],
      lower2: [
        { name: 'Leg Press', target: '3-sec descent', reps: '4×12–15', note: '🔥 Slow eccentric (3s)' },
        { name: 'Leg Extensions', target: 'Quads', reps: '3×15' },
        { name: 'Bulgarian Split Squats', target: 'Glutes/Quads', reps: '3×10/side' },
        { name: 'Lying Leg Curls', target: 'Hamstrings', reps: '3×12–15' },
        { name: 'The "Truth" Burn', target: '15% Incline @ 4.8', reps: '20 Mins', note: '🔥 MAX INCLINE. Don\'t stop.' },
      ],
      rest1: [
